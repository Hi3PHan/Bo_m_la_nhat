...
class ExamexamineesModel extends ListModel {
    ...
    {
        $config['filter_fields']=array('code','learner_code','firstname','lastname', 'stimulation','attempt','allowed', 'conclusion');
    ...
    public function getListQuery()
    {
        ...
        $columns = $db->quoteName(
            array('a.learner_id','a.code','b.code',       'b.lastname', 'b.firstname', 'a.attempt', 'c.pam1', 'c.pam2','c.pam','c.allowed', 'e.type',      'b.debtor','d.name',  'a.mark_final', 'a.module_mark', 'a.module_grade', 'a.conclusion'),
            array('id',          'code',  'learner_code', 'lastname',   'firstname',   'attempt',    'pam1',   'pam2', 'pam',  'allowed',   'stimulation', 'debtor',  'examroom','mark_final',  'module_mark',   'module_grade',   'conclusion')
        );
	    ...
	    if(is_numeric($isDebtor)){
		    $query->where('`debtor` = '.(int)$isDebtor);
	    }

...
class HtmlView extends EqaItemsHtmlView {
    protected function configureItemFields():void{
        ...
        $f = new EqaListLayoutItemFieldOption('nexaminee', 'COM_EQA_NUMBER_OF_EXAMINEES', false, false, 'text-center');
    ...
    protected function prepareDataForLayoutDefault(): void
    {
        ...
        if(!empty($this->layoutData->items)){
            $examroomIds = array_map(function ($item){return $item->id;}, $this->layoutData->items);
            $examineeCounts = DatabaseHelper::getExamineeCountOfExamrooms($examroomIds);

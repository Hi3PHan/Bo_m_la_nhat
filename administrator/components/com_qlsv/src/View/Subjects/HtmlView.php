<?php
namespace Hi3Phan\Component\QLSV\Administrator\View\Subjects;
...
//        đoạn mã này sẽ dừng thực hiện và hiển thị thông báo lỗi.
    ...
    {
        ToolbarHelper::title("Danh sách môn học");
        ToolbarHelper::addNew('Subject.add');
        ToolbarHelper::editList('Subject.edit');
        ToolbarHelper::deleteList("Bạn có chắc chắn muôn xóa ", 'Subject.delete');
    }
}

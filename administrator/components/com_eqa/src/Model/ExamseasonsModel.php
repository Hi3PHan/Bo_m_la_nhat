...
class ExamseasonsModel extends EqaListModel{
    ...
    public function getListQuery()
    {
        ...
        $columns = $db->quoteName(
            array('a.id','b.code', 'a.term', 'a.type', 'a.name', 'a.attempt','a.nexam', 'a.nexamsession', 'a.default', 'a.start', 'a.finish', 'a.statistic', 'a.description', 'a.completed'),
            array('id', 'academicyear','term', 'type',  'name',   'attempt',  'nexam',   'nexamsession',  'default', 'start', 'finish', 'statistic', 'description','completed')
        );

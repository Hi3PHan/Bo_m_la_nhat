...
{
    protected $table_name = '#__qlsv_Monhoc';
...
//        $config['filter_fields']=array('code','unit_code','firstname','published', 'ordering');
    ...
    protected function populateState($ordering = 'Mamh', $direction = 'asc')
    {
        parent::populateState($ordering, $direction); // TODO: Change the autogenerated stub
    }
    public function getTable($name = 'Subjects', $prefix = '', $options = [])
    {
    ...
    protected function getListQuery()
    {
        ...
        $query->select('*')
            ...
            ->order($this->getState('list.ordering', 'Mamh') . ' ' . $this->getState('list.direction', 'ASC'))
